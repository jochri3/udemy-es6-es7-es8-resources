...
const toutLesOrdinateurRemplissentLaConfigMin = ordinateurs.every(
  ({ ram, espaceLibre }) => ram >= 8 && espaceLibre >= 50
);

const auMoinUnOrdinateurRempliLaConfig = ordinateurs.some(
  ({ ram, espaceLibre }) => ram >= 8 && espaceLibre >= 50
);
